...
<p align="center">
	<img src="./figures/mil_model.png" width="40%">
</p>
...
3. Open simulation model `simulation/MILSIM.slx`.
   ...
   <p align="center">
   	<img src="./figures/milsim.png" width="30%">
   </p>
...
- **Mavlink**：The rc signal is sent by flight controller via mavlink protocol. So you need connect rc receiver to your flight controller and connect it with your computer. Make sure the `#define FMT_OUTPUT_PILOT_CMD` macro in fmtconfig.h is uncomment, and your flight controller can receive rc signal properly. 
...
<p align="center">
	<img src="./figures/matlab_3D.png" width="30%">
</p>
...
<p align="center">
	<img src="./figures/flightgear.png" width="30%">
</p>
